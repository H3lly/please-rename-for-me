public class MainExecV1 {
  ...
  public static String[] getFileListV1() {
    String[] fileList = { "Sense8 S1E1", "S01E02", "jgjhg5x3", "Saison 1 Episode 4", "Saison01.Episode05 " };
    return fileList;
  }
  ...
  public static String[] rename(String[] fileList, /* String nameFormat, */ String name) {
    for (int i = 0; i < fileList.length; ++i) {
      ...
      if (tmp != "None") {
        ...
        tmp = testRegex.main(".*(\\d*x\\d*).*", fileList[i]);
        if (tmp != "None") {
          System.out.println("heho");
          String season = testRegex.main(".*(\\d*)x.*", tmp);
